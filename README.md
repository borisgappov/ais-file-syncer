...
- Opent in Visual Studio 2019
- Build and run
- If you see "The system cannot find the file specified" error then install the new Chromium based Edge if you're on Windows: https://www.microsoftedgeinsider.com/en-us/. 
